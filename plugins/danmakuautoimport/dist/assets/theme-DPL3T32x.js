...
// Utilities
const {camelize,capitalize,Comment,Fragment,isProxy,isReactive,isRef,isVNode,reactive: reactive$1,shallowRef: shallowRef$5,toRaw: toRaw$1,toRef: toRef$5,unref: unref$1,watchEffect: watchEffect$3} = await importShared('vue');
...
// Utilities
const {computed: computed$6,inject: inject$5,provide: provide$2,ref: ref$4,shallowRef: shallowRef$4,unref,watchEffect: watchEffect$2} = await importShared('vue');
const DefaultsSymbol = Symbol.for('vuetify:defaults');
function createDefaults(options) {
  return ref$4(options);
}
...
function provideDefaults(defaults, options) {
  ...
  const providedDefaults = ref$4(defaults);
...
function internalUseDefaults() {
  ...
  function provideSubDefaults() {
    ...
    provide$2(DefaultsSymbol, computed$6(() => {
...
// Utilities
const {computed: computed$5,shallowRef: shallowRef$3,toValue: toValue$1,watch: watch$3} = await importShared('vue');
...
const {computed: computed$4,ref: ref$3,toRaw,watch: watch$2} = await importShared('vue');
// Composables
...
const {ref: ref$2,shallowRef: shallowRef$2,toRef: toRef$4,watch: watch$1} = await importShared('vue');
...
// Utilities
const {computed: computed$3,inject: inject$4,provide: provide$1,ref: ref$1,toRef: toRef$3} = await importShared('vue');
...
function useLocale() {
  const locale = inject$4(LocaleSymbol);
...
// Utilities
const {computed: computed$2,inject: inject$3,onScopeDispose: onScopeDispose$1,reactive,shallowRef: shallowRef$1,toRef: toRef$2,toRefs,watchEffect: watchEffect$1} = await importShared('vue');
...
// Utilities
const {inject: inject$2,toRef: toRef$1} = await importShared('vue');
...
const {computed: computed$1,inject: inject$1,toValue} = await importShared('vue');
...
// Utilities
const {computed,getCurrentScope,inject,onScopeDispose,provide,ref,shallowRef,toRef,watch,watchEffect} = await importShared('vue');
...
export { getPropertyFromItem as $, makeThemeProps as A, IconValue as B, provideDefaults as C, DefaultsSymbol as D, EventProp as E, filterInputAttrs as F, GoToSymbol as G, wrapInArray as H, IN_BROWSER as I, matchesSelector as J, omit as K, LocaleSymbol as L, callEvent as M, getCurrentInstanceName as N, getCurrentInstance as O, PREFERS_REDUCED_MOTION as P, useToggleScope as Q, pick as R, provideTheme as S, ThemeSymbol as T, isClickInsideElement as U, focusableChildren as V, focusChild as W, getNextElement as X, convertToUnit as Y, debounce as Z, clamp as _, createRange as a, camelizeProps as a0, ensureValidVNode as a1, checkPrintable as a2, SUPPORTS_MATCH_MEDIA as a3, includes as a4, isOn as a5, eventName as a6, isPrimitive as a7, templateRef as a8, destructComputed as a9, isCssColor as aa, isParsableColor as ab, parseColor as ac, getForeground as ad, findChildrenWithProvide as ae, useIcon as af, flattenFragments as ag, SUPPORTS_INTERSECTION as ah, hasEvent as ai, onlyDefinedProps as aj, breakpoints as ak, makeDisplayProps as al, consoleError as am, deprecate as an, CircularBuffer as ao, defer as ap, createDefaults as b, consoleWarn as c, createDisplay as d, createTheme as e, createIcons as f, createLocale as g, createGoTo as h, isObject as i, defineComponent as j, DisplaySymbol as k, IconSymbol as l, mergeDeep as m, useDefaults as n, useDisplay as o, padStart as p, useGoTo as q, useRtl as r, useTheme as s, propsFactory as t, useLocale as u, useProxiedModel as v, genericComponent as w, acceleratedEasing as x, deceleratedEasing as y, standardEasing as z };
