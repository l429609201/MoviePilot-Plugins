...
// Utilities
const {onBeforeUnmount: onBeforeUnmount$3,readonly: readonly$1,ref: ref$6,watch: watch$8} = await importShared('vue');
function useResizeObserver(callback) {
  ...
  if (IN_BROWSER) {
    ...
    watch$8(() => resizeRef.el, (newValue, oldValue) => {
      if (oldValue) {
...
function useBorder(props) {
  ...
  const borderClasses = computed$m(() => {
...
// Utilities
const {isRef: isRef$1,toRef: toRef$h} = await importShared('vue');
// Composables
...
function useElevation(props) {
  const elevationClasses = toRef$h(() => {
...
function useRounded(props) {
  let name = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : getCurrentInstanceName();
  const roundedClasses = computed$l(() => {
...
const {Fragment:_Fragment$3,normalizeClass:_normalizeClass$f,createElementVNode:_createElementVNode$d} = await importShared('vue');
const {toRef: toRef$g,toValue: toValue$2} = await importShared('vue');
const allowedVariants = ['elevated', 'flat', 'tonal', 'outlined', 'text', 'plain'];
function genOverlays(isClickable, name) {
  return _createElementVNode$d(_Fragment$3, null, [isClickable && _createElementVNode$d("span", {
    "key": "overlay",
    "class": _normalizeClass$f(`${name}__overlay`)
  }, null), _createElementVNode$d("span", {
    "key": "underlay",
    "class": _normalizeClass$f(`${name}__underlay`)
  }, null)]);
}
...
const {normalizeClass:_normalizeClass$e,normalizeStyle:_normalizeStyle$c,createVNode:_createVNode$i} = await importShared('vue');
...
const VBtnGroup = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    provideDefaults({
      VBtn: {
        height: toRef$f(() => props.direction === 'horizontal' ? 'auto' : null),
        baseColor: toRef$f(() => props.baseColor),
        color: toRef$f(() => props.color),
        density: toRef$f(() => props.density),
        flat: true,
        variant: toRef$f(() => props.variant)
      }
    });
    useRender(() => {
      return _createVNode$i(props.tag, {
        "class": _normalizeClass$e(['v-btn-group', `v-btn-group--${props.direction}`, {
...
const {computed: computed$k,inject: inject$2,onBeforeUnmount: onBeforeUnmount$2,onMounted: onMounted$1,onUpdated,provide: provide$2,reactive: reactive$1,toRef: toRef$e,unref,useId,watch: watch$7} = await importShared('vue');
...
function useGroupItem(props, injectKey) {
  ...
  const value = toRef$e(() => props.value);
  const disabled = computed$k(() => !!(group.disabled.value || props.disabled));
  function register() {
    group?.register({
      id,
      value,
  ...
  const isSelected = computed$k(() => {
    return group.isSelected(id);
  });
  const isFirst = computed$k(() => {
    return group.items.value[0].id === id;
  });
  const isLast = computed$k(() => {
    return group.items.value[group.items.value.length - 1].id === id;
  });
  const selectedClass = computed$k(() => isSelected.value && [group.selectedClass.value, props.selectedClass]);
  watch$7(isSelected, value => {
...
function useGroup(props, injectKey) {
  ...
  const state = {
    ...
    selectedClass: toRef$e(() => props.selectedClass),
    items: toRef$e(() => items),
...
const {mergeProps:_mergeProps$7,createVNode:_createVNode$h} = await importShared('vue');
...
genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      return _createVNode$h(VBtnGroup, _mergeProps$7({
...
const {normalizeClass:_normalizeClass$d,normalizeStyle:_normalizeStyle$b,createVNode:_createVNode$g} = await importShared('vue');
const {shallowRef: shallowRef$9,Text} = await importShared('vue');
...
const VIcon = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      return _createVNode$g(iconData.value.component, {
        "tag": props.tag,
        "icon": iconData.value.icon,
        "class": _normalizeClass$d(['v-icon', 'notranslate', themeClasses.value, sizeClasses.value, textColorClasses.value, {
...
// Utilities
const {onScopeDispose: onScopeDispose$1,ref: ref$5,shallowRef: shallowRef$8,watch: watch$6} = await importShared('vue');
function useIntersectionObserver(callback, options) {
  ...
  if (SUPPORTS_INTERSECTION) {
    ...
    watch$6(intersectionRef, (newValue, oldValue) => {
      if (oldValue) {
        observer.unobserve(oldValue);
...
const {normalizeClass:_normalizeClass$c,normalizeStyle:_normalizeStyle$a,createElementVNode:_createElementVNode$c,createVNode:_createVNode$f} = await importShared('vue');
const {ref: ref$4,toRef: toRef$d,watchEffect: watchEffect$2} = await importShared('vue');
...
const VProgressCircular = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const normalizedValue = toRef$d(() => clamp(parseFloat(props.modelValue), 0, 100));
    const width = toRef$d(() => Number(props.width));
    const size = toRef$d(() => {
      // Get size from element if size prop value is small, large etc
      return sizeStyles.value ? Number(props.size) : contentRect.value ? contentRect.value.width : Math.max(width.value, 32);
    });
    const diameter = toRef$d(() => MAGIC_RADIUS_CONSTANT / (1 - width.value / size.value) * 2);
    const strokeWidth = toRef$d(() => width.value / size.value * diameter.value);
    const strokeDashOffset = toRef$d(() => convertToUnit((100 - normalizedValue.value) / 100 * CIRCUMFERENCE));
    watchEffect$2(() => {
    ...
    useRender(() => _createVNode$f(props.tag, {
      "ref": root,
      "class": _normalizeClass$c(['v-progress-circular', {
      ...
      "style": _normalizeStyle$a([sizeStyles.value, textColorStyles.value, props.style]),
      "role": "progressbar",
      "aria-valuemin": "0",
      "aria-valuemax": "100",
      "aria-valuenow": props.indeterminate ? undefined : normalizedValue.value
    }, {
      default: () => [_createElementVNode$c("svg", {
        "style": {
          transform: `rotate(calc(-90deg + ${Number(props.rotate)}deg))`
        },
        "xmlns": "http://www.w3.org/2000/svg",
        "viewBox": `0 0 ${diameter.value} ${diameter.value}`
      }, [_createElementVNode$c("circle", {
        "class": _normalizeClass$c(['v-progress-circular__underlay', underlayColorClasses.value]),
        "style": _normalizeStyle$a(underlayColorStyles.value),
        "fill": "transparent",
        "cx": "50%",
        "cy": "50%",
        ...
        "stroke-dashoffset": 0
      }, null), _createElementVNode$c("circle", {
...
function useDimension(props) {
  const dimensionStyles = computed$j(() => {
    const styles = {};
...
function useLocation(props) {
  ...
  const locationStyles = computed$i(() => {
...
// Utilities
const {computed: computed$h,toRef: toRef$c,toValue: toValue$1} = await importShared('vue');
// Composables
...
function useChunks(props, containerWidth) {
  const hasChunks = toRef$c(() => !!props.chunkCount || !!props.chunkWidth);
  const chunkWidth = computed$h(() => {
  ...
  const chunkGap = toRef$c(() => Number(props.chunkGap));
  const chunksMaskStyles = computed$h(() => {
    if (!hasChunks.value) {
      return {};
    }
...
const {normalizeClass:_normalizeClass$b,createElementVNode:_createElementVNode$b,normalizeStyle:_normalizeStyle$9,createVNode:_createVNode$e} = await importShared('vue');
const {computed: computed$g,ref: ref$3,shallowRef: shallowRef$7,Transition: Transition$2,watchEffect: watchEffect$1} = await importShared('vue');
...
const VProgressLinear = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const max = computed$g(() => parseFloat(props.max));
    const height = computed$g(() => parseFloat(props.height));
    const normalizedBuffer = computed$g(() => clamp(parseFloat(props.bufferValue) / max.value * 100, 0, 100));
    const normalizedValue = computed$g(() => clamp(parseFloat(progress.value) / max.value * 100, 0, 100));
    const isReversed = computed$g(() => isRtl.value !== props.reverse);
    const transition = computed$g(() => props.indeterminate ? 'fade-transition' : 'slide-x-transition');
    const containerWidth = shallowRef$7(0);
    const {
      hasChunks,
      chunksMaskStyles,
      snapValueToChunk
    ...
    const bufferWidth = computed$g(() => {
      return hasChunks.value ? snapValueToChunk(normalizedBuffer.value) : normalizedBuffer.value;
    });
    const barWidth = computed$g(() => {
    ...
    useRender(() => _createVNode$e(props.tag, {
      "ref": root,
      "class": _normalizeClass$b(['v-progress-linear', {
      ...
      default: () => [props.stream && _createElementVNode$b("div", {
        "key": "stream",
        "class": _normalizeClass$b(['v-progress-linear__stream', textColorClasses.value]),
        "style": {
      ...
      }, null), _createElementVNode$b("div", {
        "class": _normalizeClass$b(['v-progress-linear__background', backgroundColorClasses.value]),
        "style": _normalizeStyle$9([backgroundColorStyles.value, {
          opacity: parseFloat(props.bgOpacity),
          width: props.stream ? 0 : undefined
        }])
      }, null), _createElementVNode$b("div", {
        "class": _normalizeClass$b(['v-progress-linear__buffer', bufferColorClasses.value]),
        "style": _normalizeStyle$9([bufferColorStyles.value, {
          opacity: parseFloat(props.bufferOpacity),
          width: convertToUnit(bufferWidth.value, '%')
        }])
      }, null), _createVNode$e(Transition$2, {
        "name": transition.value
      }, {
        default: () => [!props.indeterminate ? _createElementVNode$b("div", {
          "class": _normalizeClass$b(['v-progress-linear__determinate', barColorClasses.value]),
          "style": _normalizeStyle$9([barColorStyles.value, {
            width: convertToUnit(barWidth.value, '%')
          }])
        }, null) : _createElementVNode$b("div", {
          "class": "v-progress-linear__indeterminate"
        }, [['long', 'short'].map(bar => _createElementVNode$b("div", {
          "key": bar,
          "class": _normalizeClass$b(['v-progress-linear__indeterminate', bar, barColorClasses.value]),
          "style": _normalizeStyle$9(barColorStyles.value)
        }, null))])]
      }), slots.default && _createElementVNode$b("div", {
...
const {createVNode:_createVNode$d,normalizeClass:_normalizeClass$a,createElementVNode:_createElementVNode$a} = await importShared('vue');
...
function LoaderSlot(props, _ref) {
  ...
  return _createElementVNode$a("div", {
    "class": _normalizeClass$a(`${props.name}__loader`)
  }, [slots.default?.({
    color: props.color,
    isActive: props.active
  }) || _createVNode$d(VProgressLinear, {
...
// Utilities
const {computed: computed$f,nextTick: nextTick$4,onScopeDispose,reactive,resolveDynamicComponent,toRef: toRef$9} = await importShared('vue');
function useRoute() {
  const vm = getCurrentInstance('useRoute');
  return computed$f(() => vm?.proxy?.$route);
}
function useRouter() {
...
function useLink(props, attrs) {
  ...
  if (typeof RouterLink === 'string' || !('useLink' in RouterLink)) {
    const href = toRef$9(() => props.href);
    return {
      isLink,
      isRouterLink: toRef$9(() => false),
      isClickable,
      href,
      linkProps: reactive({
        href
  ...
  const link = computed$f(() => props.to ? routerLink : undefined);
  ...
  const href = computed$f(() => props.to ? link.value?.route.value.href : props.href);
  const isRouterLink = toRef$9(() => !!props.to);
  return {
    isLink,
    isRouterLink,
    isClickable,
    ...
    linkProps: reactive({
      href,
      'aria-current': toRef$9(() => isActive.value ? 'page' : undefined),
      'aria-disabled': toRef$9(() => props.disabled && isLink.value ? 'true' : undefined),
      tabindex: toRef$9(() => props.disabled && isLink.value ? '-1' : undefined)
    })
  };
}
...
// Utilities
const {nextTick: nextTick$3,watch: watch$5} = await importShared('vue');


// Types

function useSelectLink(link, select) {
  watch$5(() => link.isActive?.value, isActive => {
...
const {createVNode:_createVNode$c,createElementVNode:_createElementVNode$9,mergeProps:_mergeProps$6} = await importShared('vue');
const {computed: computed$e,toDisplayString: toDisplayString$2,toRef: toRef$8,withDirectives: withDirectives$1} = await importShared('vue');
...
const VBtn = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const color = toRef$8(() => isActive.value ? props.activeColor ?? props.color : props.color);
    const variantProps = computed$e(() => {
    ...
    const isDisabled = computed$e(() => group?.disabled.value || props.disabled);
    const isElevated = toRef$8(() => {
      return props.variant === 'elevated' && !(props.disabled || props.flat || props.border);
    });
    const valueAttr = computed$e(() => {
    ...
    useRender(() => {
      ...
      return withDirectives$1(_createVNode$c(Tag, _mergeProps$6(link.linkProps, {
        ...
        default: () => [genOverlays(true, 'v-btn'), !props.icon && hasPrepend && _createElementVNode$9("span", {
          "key": "prepend",
          "class": "v-btn__prepend"
        }, [!slots.prepend ? _createVNode$c(VIcon, {
          "key": "prepend-icon",
        ...
        }, slots.prepend)]), _createElementVNode$9("span", {
          "class": "v-btn__content",
          "data-no-activator": ""
        }, [!slots.default && hasIcon ? _createVNode$c(VIcon, {
          "key": "content-icon",
          "icon": props.icon
        }, null) : _createVNode$c(VDefaultsProvider, {
        ...
        })]), !props.icon && hasAppend && _createElementVNode$9("span", {
          "key": "append",
          "class": "v-btn__append"
        }, [!slots.append ? _createVNode$c(VIcon, {
          "key": "append-icon",
        ...
        }, slots.append)]), !!props.loading && _createElementVNode$9("span", {
          "key": "loader",
          "class": "v-btn__loader"
        }, [slots.loader?.() ?? _createVNode$c(VProgressCircular, {
...
const {normalizeClass:_normalizeClass$9,normalizeStyle:_normalizeStyle$8,createElementVNode:_createElementVNode$8,mergeProps:_mergeProps$5,createVNode:_createVNode$b} = await importShared('vue');
...
const VAlert = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return isActive.value && _createVNode$b(props.tag, {
        "class": _normalizeClass$9(['v-alert', props.border && {
          'v-alert--border': !!props.border,
          [`v-alert--border-${props.border === true ? 'start' : props.border}`]: true
        }, {
          'v-alert--prominent': props.prominent
        }, themeClasses.value, colorClasses.value, densityClasses.value, elevationClasses.value, positionClasses.value, roundedClasses.value, variantClasses.value, props.class]),
        "style": _normalizeStyle$8([colorStyles.value, dimensionStyles.value, locationStyles.value, props.style]),
        "role": "alert"
      }, {
        default: () => [genOverlays(false, 'v-alert'), props.border && _createElementVNode$8("div", {
          "key": "border",
          "class": _normalizeClass$9(['v-alert__border', textColorClasses.value]),
          "style": _normalizeStyle$8(textColorStyles.value)
        }, null), hasPrepend && _createElementVNode$8("div", {
          "key": "prepend",
          "class": "v-alert__prepend"
        }, [!slots.prepend ? _createVNode$b(VIcon, _mergeProps$5({
          "key": "prepend-icon"
        }, iconProps), null) : _createVNode$b(VDefaultsProvider, {
          "key": "prepend-defaults",
          "disabled": !icon.value,
          "defaults": {
            VIcon: {
        ...
        }, [hasTitle && _createVNode$b(VAlertTitle, {
          "key": "title"
        }, {
          default: () => [slots.title?.() ?? props.title]
        }), slots.text?.() ?? props.text, slots.default?.()]), slots.append && _createElementVNode$8("div", {
          "key": "append",
          "class": "v-alert__append"
        }, [slots.append()]), hasClose && _createElementVNode$8("div", {
          "key": "close",
          "class": "v-alert__close"
        }, [!slots.close ? _createVNode$b(VBtn, _mergeProps$5({
          "key": "close-btn",
          "icon": props.closeIcon,
          "size": "x-small",
          "variant": "text"
        }, closeProps.value), null) : _createVNode$b(VDefaultsProvider, {
          "key": "close-defaults",
          "defaults": {
            VBtn: {
              icon: props.closeIcon,
...
const {capitalize: capitalize$1,computed: computed$c,h: h$3} = await importShared('vue');
...
const {capitalize,computed: computed$b,h: h$2} = await importShared('vue');
...
// Utilities
const {h: h$1,Transition: Transition$1,TransitionGroup: TransitionGroup$1} = await importShared('vue');
...
function createCssTransition(name, origin, mode) {
  return genericComponent()({
    ...
    setup(props, _ref) {
      ...
      return () => {
        const tag = props.group ? TransitionGroup$1 : Transition$1;
        return h$1(tag, {
...
const {normalizeStyle:_normalizeStyle$7,createElementVNode:_createElementVNode$7,normalizeClass:_normalizeClass$8} = await importShared('vue');
const {computed: computed$a} = await importShared('vue');
function useAspectStyles(props) {
  return {
    aspectStyles: computed$a(() => {
...
const VResponsive = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => _createElementVNode$7("div", {
      "class": _normalizeClass$8(['v-responsive', {
        'v-responsive--inline': props.inline
      }, props.class]),
      "style": _normalizeStyle$7([dimensionStyles.value, props.style])
    }, [_createElementVNode$7("div", {
      "class": "v-responsive__sizer",
      "style": _normalizeStyle$7(aspectStyles.value)
    }, null), slots.additional?.(), slots.default && _createElementVNode$7("div", {
      "class": _normalizeClass$8(['v-responsive__content', props.contentClass])
    }, [slots.default()])]));
    return {};
  }
});
...
// Utilities
const {h,mergeProps: mergeProps$1,Transition,TransitionGroup} = await importShared('vue');
...
const {normalizeClass:_normalizeClass$7,createElementVNode:_createElementVNode$6,createVNode:_createVNode$a,Fragment:_Fragment$2,mergeProps:_mergeProps$4,withDirectives:_withDirectives$3} = await importShared('vue');
const {computed: computed$9,nextTick: nextTick$2,onBeforeMount: onBeforeMount$2,onBeforeUnmount: onBeforeUnmount$1,ref: ref$2,shallowRef: shallowRef$6,toRef: toRef$6,vShow,watch: watch$4,withDirectives} = await importShared('vue');
...
const VImg = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const currentSrc = shallowRef$6(''); // Set from srcset
    const image = ref$2();
    const state = shallowRef$6(props.eager ? 'loading' : 'idle');
    const naturalWidth = shallowRef$6();
    const naturalHeight = shallowRef$6();
    const normalisedSrc = computed$9(() => {
    ...
    const aspectRatio = computed$9(() => {
      return normalisedSrc.value.aspect || naturalWidth.value / naturalHeight.value || 0;
    });
    watch$4(() => props.src, () => {
      init(state.value !== 'idle');
    });
    watch$4(aspectRatio, (val, oldVal) => {
    ...
    const __image = () => {
      ...
      const img = _createElementVNode$6("img", {
        "class": _normalizeClass$7(['v-img__img', containClasses.value]),
        "style": {
      ...
      return _createVNode$a(MaybeTransition, {
        "transition": props.transition,
        "appear": true
      }, {
        default: () => [withDirectives(sources ? _createElementVNode$6("picture", {
          "class": "v-img__picture"
        }, [sources, img]) : img, [[vShow, state.value === 'loaded']])]
      });
    };
    const __preloadImage = () => _createVNode$a(MaybeTransition, {
      "transition": props.transition
    }, {
      default: () => [normalisedSrc.value.lazySrc && state.value !== 'loaded' && _createElementVNode$6("img", {
        "class": _normalizeClass$7(['v-img__img', 'v-img__img--preload', containClasses.value]),
        "style": {
          objectPosition: props.position
        },
        "crossorigin": props.crossorigin,
    ...
    const __placeholder = () => {
      ...
      return _createVNode$a(MaybeTransition, {
        ...
        default: () => [(state.value === 'loading' || state.value === 'error' && !slots.error) && _createElementVNode$6("div", {
    ...
    const __error = () => {
      ...
      return _createVNode$a(MaybeTransition, {
        ...
        default: () => [state.value === 'error' && _createElementVNode$6("div", {
          "class": "v-img__error"
        }, [slots.error()])]
      });
    };
    ...
    {
      const stop = watch$4(aspectRatio, val => {
        if (val) {
    ...
    useRender(() => {
      ...
      return _withDirectives$3(_createVNode$a(VResponsive, _mergeProps$4({
        "class": ['v-img', {
        ...
        additional: () => _createElementVNode$6(_Fragment$2, null, [_createVNode$a(__image, null, null), _createVNode$a(__preloadImage, null, null), _createVNode$a(__gradient, null, null), _createVNode$a(__placeholder, null, null), _createVNode$a(__error, null, null)]),
        default: slots.default
      }), [[Intersect, {
        handler: init,
...
const {createVNode:_createVNode$9,normalizeClass:_normalizeClass$6,normalizeStyle:_normalizeStyle$6} = await importShared('vue');
...
const VAvatar = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => _createVNode$9(props.tag, {
      "class": _normalizeClass$6(['v-avatar', {
        'v-avatar--start': props.start,
        'v-avatar--end': props.end
      }, themeClasses.value, borderClasses.value, colorClasses.value, densityClasses.value, roundedClasses.value, sizeClasses.value, variantClasses.value, props.class]),
      "style": _normalizeStyle$6([colorStyles.value, sizeStyles.value, props.style])
    }, {
      default: () => [!slots.default ? props.image ? _createVNode$9(VImg, {
        "key": "image",
        "src": props.image,
        "alt": "",
        "cover": true
      }, null) : props.icon ? _createVNode$9(VIcon, {
        "key": "icon",
        "icon": props.icon
      }, null) : props.text : _createVNode$9(VDefaultsProvider, {
        "key": "content-defaults",
        "defaults": {
          VImg: {
            cover: true,
...
const {createVNode:_createVNode$8,normalizeClass:_normalizeClass$5,createElementVNode:_createElementVNode$5,normalizeStyle:_normalizeStyle$5} = await importShared('vue');
const {computed: computed$8,shallowRef: shallowRef$5,watch: watch$3} = await importShared('vue');
...
const VSlideGroup = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const isHorizontal = computed$8(() => props.direction === 'horizontal');
    const {
    ...
    const firstSelectedIndex = computed$8(() => {
      if (!group.selected.value.length) return -1;
      return group.items.value.findIndex(item => item.id === group.selected.value[0]);
    });
    const lastSelectedIndex = computed$8(() => {
      if (!group.selected.value.length) return -1;
    ...
    const hasOverflowOrScroll = computed$8(() => isOverflowing.value || Math.abs(scrollOffset.value) > 0);
    const hasAffixes = computed$8(() => {
    ...
    const hasPrev = computed$8(() => {
      // 1 pixel in reserve, may be lost after rounding
      return Math.abs(scrollOffset.value) > 1;
    });
    const hasNext = computed$8(() => {
    ...
    useRender(() => _createVNode$8(props.tag, {
      "class": _normalizeClass$5(['v-slide-group', {
      ...
      default: () => [hasAffixes.value && _createElementVNode$5("div", {
        "key": "prev",
        "class": _normalizeClass$5(['v-slide-group__prev', {
        ...
        "key": "container",
        "ref": containerRef,
        "class": _normalizeClass$5(['v-slide-group__container', props.contentClass]),
        "onScroll": onScroll
      }, [_createElementVNode$5("div", {
        "ref": contentRef,
        ...
        "key": "next",
        "class": _normalizeClass$5(['v-slide-group__next', {
...
const {createVNode:_createVNode$6,vShow:_vShow$1,createElementVNode:_createElementVNode$4,withDirectives:_withDirectives$2,Fragment:_Fragment$1,mergeProps:_mergeProps$2} = await importShared('vue');
const {computed: computed$7,toDisplayString: toDisplayString$1,toRef: toRef$4,watch: watch$2} = await importShared('vue');
...
const VChip = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const isClickable = computed$7(() => !props.disabled && props.link !== false && (!!group || props.link || link.isClickable.value));
    ...
    return () => {
      ...
      return isActive.value && _withDirectives$2(_createVNode$6(Tag, _mergeProps$2(link.linkProps, {
        ...
        default: () => [genOverlays(isClickable.value, 'v-chip'), hasFilter && _createVNode$6(VExpandXTransition, {
          ...
          default: () => [_withDirectives$2(_createElementVNode$4("div", {
        ...
        }, [!slots.prepend ? _createElementVNode$4(_Fragment$1, null, [props.prependIcon && _createVNode$6(VIcon, {
          "key": "prepend-icon",
          "icon": props.prependIcon,
          "start": true
        ...
        }, [!slots.append ? _createElementVNode$4(_Fragment$1, null, [props.appendIcon && _createVNode$6(VIcon, {
          "key": "append-icon",
          "end": true,
          "icon": props.appendIcon
        ...
        }, slots.append)]), hasClose && _createElementVNode$4("button", _mergeProps$2({
          "key": "close",
          "class": "v-chip__close",
          "type": "button",
...
const {normalizeClass:_normalizeClass$4,normalizeStyle:_normalizeStyle$4,createElementVNode:_createElementVNode$3} = await importShared('vue');
...
const VDivider = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const dividerStyles = computed$6(() => {
      const styles = {};
      if (props.length) {
    ...
    useRender(() => {
      const divider = _createElementVNode$3("hr", {
        "class": _normalizeClass$4([{
          'v-divider': true,
          'v-divider--inset': props.inset,
          'v-divider--vertical': props.vertical
        }, themeClasses.value, textColorClasses.value, props.class]),
        "style": _normalizeStyle$4([dividerStyles.value, textColorStyles.value, {
      ...
      return _createElementVNode$3("div", {
        "class": _normalizeClass$4(['v-divider__wrapper', {
          'v-divider__wrapper--vertical': props.vertical,
          'v-divider__wrapper--inset': props.inset
        }])
      }, [divider, _createElementVNode$3("div", {
...
export { makePositionProps as $, makeItemsProps as A, VList as B, VListItem as C, VDivider as D, VListSubheader as E, VAvatar as F, VChip as G, VScaleTransition as H, Intersect as I, VProgressCircular as J, VRow as K, LoaderSlot as L, MaybeTransition as M, VCol as N, VAlert as O, makeTagProps as P, createSimpleFunctional as Q, Ripple as R, useBorder as S, useVariant as T, useElevation as U, VIcon as V, useLocation as W, usePosition as X, useLink as Y, makeVariantProps as Z, makeRouterProps as _, makeDensityProps as a, makeLocationProps as a0, makeElevationProps as a1, makeBorderProps as a2, genOverlays as a3, VImg as a4, VBtn as a5, VListItemTitle as a6, VListItemSubtitle as a7, useDensity as b, useTextColor as c, deepEqual as d, useBackgroundColor as e, makeTransitionProps as f, VSlideYTransition as g, makeDimensionProps as h, useDimension as i, flipSide as j, flipAlign as k, flipCorner as l, makeComponentProps as m, getAxis as n, useRouter as o, parseAnchor as p, useBackButton as q, VDefaultsProvider as r, makeRoundedProps as s, makeLoaderProps as t, useRender as u, useLoader as v, useRounded as w, VExpandXTransition as x, useResizeObserver as y, useItems as z };
