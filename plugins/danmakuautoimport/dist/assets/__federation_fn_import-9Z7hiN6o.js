...
const moduleMap = {'vue':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-uKUkTJ-n.js', import.meta.url).href),import:true},'vuetify':{get:()=>()=>__federation_import(new URL('__federation_shared_vuetify-VRR2CHb-.js', import.meta.url).href),import:true}};
