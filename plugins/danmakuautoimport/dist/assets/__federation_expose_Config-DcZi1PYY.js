...
import { c as createForm, u as useRender, f as forwardRefs, m as makeFormProps, a as makeComponentProps, b as animate, g as getTargetBox, n as nullifyTransforms, d as useScopeId, V as VMenuSymbol, e as VOverlay, h as VDefaultsProvider, i as makeVOverlayProps, j as useResizeObserver, k as useDimension, l as getScrollParent, o as makeDimensionProps, p as useItems, q as useForm, r as deepEqual, s as makeTransitionProps, t as makeVTextFieldProps, v as makeItemsProps, w as VTextField, x as VIcon, y as VList, z as VListItem, A as VDivider, B as VListSubheader, C as VCheckboxBtn, D as VAvatar, E as VChip, F as useLoader, G as useFocus, H as makeVSelectionControlProps, I as makeVInputProps, J as VInput, K as VSelectionControl, L as VScaleTransition, M as LoaderSlot, N as VProgressCircular, _ as _export_sfc, O as VCard, P as VCardTitle, Q as VCardText, R as VRow, S as VCol, T as VCardActions, U as VBtn, W as VSpacer } from './VTextField-ghKoNuv5.js';
import { t as genericComponent, v as propsFactory, P as PREFERS_REDUCED_MOTION, w as acceleratedEasing, x as deceleratedEasing, y as standardEasing, z as useProxiedModel, r as useRtl, A as isClickInsideElement, B as focusableChildren, I as IN_BROWSER, C as omit, E as focusChild, F as getNextElement, o as useDisplay, H as debounce, J as clamp, K as getPropertyFromItem, M as getCurrentInstance, N as useToggleScope, O as convertToUnit, u as useLocale, Q as wrapInArray, R as IconValue, S as camelizeProps, U as ensureValidVNode, V as checkPrintable, W as matchesSelector, X as SUPPORTS_MATCH_MEDIA, Y as filterInputAttrs } from './theme-DXwvKF_I.js';
...
// Utilities
const {Transition,mergeProps:_mergeProps$4,createVNode:_createVNode$5} = await importShared('vue');
...
const VDialogTransition = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    return () => {
      return props.target ? _createVNode$5(Transition, _mergeProps$4({
        "name": "dialog-transition"
      }, functions, {
        "css": false
      }), slots) : _createVNode$5(Transition, {
        "name": "dialog-transition"
      }, slots);
    };
  }
...
const {createVNode:_createVNode$4,mergeProps:_mergeProps$3} = await importShared('vue');
const {computed: computed$3,inject,mergeProps: mergeProps$1,nextTick: nextTick$2,onBeforeUnmount,onDeactivated,provide,ref: ref$4,shallowRef: shallowRef$3,toRef: toRef$3,useId: useId$2,watch: watch$4} = await importShared('vue');
...
const VMenu = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const openChildren = shallowRef$3(new Set());
    provide(VMenuSymbol, {
      register() {
    ...
    const activatorProps = computed$3(() => mergeProps$1({
      'aria-haspopup': 'menu',
    ...
    useRender(() => {
      ...
      return _createVNode$4(VOverlay, _mergeProps$3({
        "ref": overlay,
        "id": id.value,
